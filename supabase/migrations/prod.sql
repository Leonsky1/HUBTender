...
-- Generated: 2025-11-24T10:48:59.220518
-- Database: postgres
...
-- Элементы позиций заказчика (Bill of Quantities Items)
...
-- Позиции заказчика из ВОРа (Bill of Quantities)
...
-- Правила распределения затрат и наценок между КП (материалы) и работами для каждого        
  тендера
...
COMMENT ON COLUMN public.tender_pricing_distribution.component_material_base_target IS 'Куда
  направляется базовая стоимость компонентных материалов (мат-комп.): material = КП, work = работы';
COMMENT ON COLUMN public.tender_pricing_distribution.component_material_markup_target IS 'Куда
  направляется наценка на компонентные материалы (мат-комп.): material = КП, work = работы';
COMMENT ON COLUMN public.tender_pricing_distribution.component_work_base_target IS 'Куда направляется    
   базовая стоимость компонентных работ (раб-комп.): material = КП, work = работы';
COMMENT ON COLUMN public.tender_pricing_distribution.component_work_markup_target IS 'Куда
  направляется наценка на компонентные работы (раб-комп.): material = КП, work = работы';
